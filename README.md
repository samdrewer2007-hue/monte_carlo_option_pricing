...
The standard error is calculated by dividing the standard deviation on the discounted payoffs by the square root of the number of simulations. This is then multiplied by 1.96 to produce the approximate 95% confidence interval.
